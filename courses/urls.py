...
urlpatterns = [
    ...
    path('<int:course_id>/add-grade/<int:student_id>/', views.add_grade, name='add_grade'),
    path('<int:course_id>/assignments/create/', views.assignment_create, name='assignment_create'),
    path('<int:course_id>/assignments/<int:assignment_id>/edit/', views.assignment_edit, name='assignment_edit'),
    path('<int:course_id>/assignments/<int:assignment_id>/delete/', views.assignment_delete, name='assignment_delete'),
